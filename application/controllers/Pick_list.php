...
class Pick_list extends CI_Controller
{
    ...
    public function index($method)
    {
        ...
        switch ($method) {
            ...
            case 'dispatch-detail':
                $this->general_issue_id = base64_decode($this->uri->segment(2));
                $this->dispatch_detail($this->general_issue_id);
                break;
            default:
                break;
        };
    ...
    {
        $this->data['dispatch_list'] = $this->Pick_list->dispatch_report(array('store_id' => $this->store_id));
        // pr($this->data['dispatch_list']);exit;
        $this->customer_option = $this->Options->customer_option();
    }
