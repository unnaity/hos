		...
		<div class="main-container container-fluid">
			...
			<div class="page-header" style="min-height:unset;">
                ...
                <div class="btn btn-list">
					<a href="<?php echo BASE_URL.'put-away-list';?>">
			...
			<div class="row">
				<div class="col-lg-12">
					<div class="card custom-card">
						<div class="card-body">
                            <form action="" id="create-put-away" method="POST" data-parsley-validate="">
                                <div class="row">
                                    <div class="col-md-6">
                                    ...
                                    <div class="col-md-6">	
                                        <div class="row row-xs align-items-center mg-b-20">
                                            ...
                                            <div class="col-md-5 mg-t-5 mg-md-t-0">
                                                <input class="form-control" type="text" name="box_no" id="box_no" required value="">
                                            </div>
                                        </div>
                                        <div id="p_detail"></div>
                                    </div>    
