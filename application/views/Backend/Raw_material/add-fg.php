<!-- Basic modal -->
<div class="modal" id="add-fg">
	<div class="modal-dialog" role="document">
		<div class="modal-content modal-content-demo">
			<form action="<?php echo BASE_URL . 'add-fg' ?>" method="POST" id="add-fg" data-parsley-validate="">
				...
				<div class="modal-body">
					...
					<div class="row row-xs align-items-center" style="margin-bottom: 15px;">
						...
						<div class="col-md-8 mg-t-5 mg-md-t-0">
							<select class="form-control" name="sales_qty" required id="sales_qty">
