	...
	<div class="side-app">
		<div class="main-container container-fluid">
			...
			<div class="page-header">
				<h4 class="text-start">Product GRN List</h4>
				<div class="btn btn-list">
					<!--a class="btn ripple btn-secondary" href="#" title="Download"><i class="fe fe-download"></i></a-->
					<a class="btn ripple btn-success" href="<?php echo BASE_URL.'create-raw-material-grn'?>" title="Add Raw Material"><i class="fe fe-plus"></i></a>
				</div>
			</div>
			<!-- End Page Header -->
						...
						<div class="card-body">							
							<div class="table-responsive">
								<table id="example2" class="table table-striped table-bordered text-nowrap" style="border-left:1px solid #e1e6f1;">
									...
									<tbody>
									<?php if(isset($rm_grn_list)):
									// pr($rm_grn_list);
										foreach($rm_grn_list as $obj): ?>
										<tr>
                                            <td><?php echo $obj->rm_grn_no ?></td>
											...
											<!-- <td>
                                                <a class="btn btn-sm btn-info" href="<?php echo BASE_URL.'rm-box-slip/'.$obj->rm_grn_detail_id; ?>" title="Print Barcode" target="_blank"><i class="fe fe-printer"></i>
											</td> -->
										</tr>
									<?php endforeach;
