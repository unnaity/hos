		...
		<div class="main-container container-fluid">
			...
			<div class="page-header" style="min-height:unset;">
				...
				<div class="btn btn-list">
					<a href="<?php echo BASE_URL . 'subcategory-list' ?>">
											...
											<div class="row">
												...
												<div class="col-md-12">
													<div class="form-group">
														...
														<input class="form-control" name="subcategory_name" id="subcategory_name" value="<?php echo $subcategory_detail->subcategory; ?>" placeholder="Enter subcategory name" required="" type="text">
													</div>
												</div>
											</div>

											<input name="subcategory_id" id="subcategory_id" value="<?php echo $subcategory_detail->subcategory_id; ?>" required="" type="hidden">
