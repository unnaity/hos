		...
		<div class="main-container container-fluid">
			...
			<div class="page-header" style="min-height:unset;">
				...
				<div class="btn btn-list">
					<a href="<?php echo BASE_URL . 'size-list' ?>">
									...
									<div class="tab-content">
										<form action="" method="POST" data-parsley-validate="">
											<div class="row">
												...
												<div class="col-md-12">
													<div class="form-group">
														<label class="form-label">Size name: <span class="tx-danger">*</span></label>
														<input class="form-control" name="size_name" id="size_name" value="<?php echo $size_detail->size; ?>" placeholder="Enter size name" required="" type="text">
													</div>
												</div>
											</div>

											<input name="size_id" id="size_id" value="<?php echo $size_detail->size_id; ?>" required="" type="hidden">
