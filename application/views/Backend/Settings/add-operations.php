...
<div class="modal" id="add-operations">
	<div class="modal-dialog" role="document">
		<div class="modal-content modal-content-demo">
			<form action="<?php echo BASE_URL.'operations-list'?>" method="POST" id="add-<?php echo $page_title?>" data-parsley-validate="">
				...
				<div class="modal-body">
					...
					<div class="row row-xs align-items-center mg-b-20">
						...
						<div class="col-md-8 mg-t-5 mg-md-t-0">	
							<input class="form-control" name="operations" id="operations" value="<?php echo $operations_detail->operation_title ?? NULL; ?>" placeholder="Enter <?php echo $page_title?> name" required="" type="text">
						</div>
					</div>
				</div>
