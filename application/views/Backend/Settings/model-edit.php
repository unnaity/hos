		...
		<div class="main-container container-fluid">
			...
			<div class="page-header" style="min-height:unset;">
				...
				<div class="btn btn-list">
					<a href="<?php echo BASE_URL . 'model-list' ?>">
									...
									<div class="tab-content">
										<form action="" method="POST" data-parsley-validate="">
											<div class="row">
												...
												<div class="col-md-12">
													<div class="form-group">
														<label class="form-label">Model name: <span class="tx-danger">*</span></label>
														<input class="form-control" name="model_name" id="model_name" value="<?php echo $model_detail->model; ?>" placeholder="Enter model name" required="" type="text">
													</div>
												</div>
											</div>

											<input name="model_id" id="model_id" value="<?php echo $model_detail->model_id; ?>" required="" type="hidden">
