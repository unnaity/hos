											...
											<div class="row">
												...
												<div class="col-md-12">
													<div class="form-group">
														...
														<input class="form-control" name="hsn_code" id="hsn_code" value="<?php echo $category_detail->hsn_code ?? NULL; ?>" placeholder="Enter hsn code" required="" type="text">
													</div>
												</div>
											</div>

											<input name="hsn_code" id="hsn_code" value="<?php echo $category_detail->hsn_code ?? NULL; ?>" required="" type="hidden">
