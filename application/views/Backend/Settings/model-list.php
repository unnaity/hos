						...
						<div class="card-body">
							<div class="card-header border-bottom-0 p-0">
								...
								<div class="btn btn-list" style="float: right;margin-top:-4px;">
									...
									<a class="btn ripple btn-success" href="#" data-bs-target="#add-model" data-bs-toggle="modal" title="Add New Model"><i class="fe fe-plus"></i></a>
								</div>								
							</div>
								...
								<table id="example2" class="table table-striped table-bordered text-nowrap" style="border-left:1px solid #e1e6f1;">
									...
									<?php if($model_list):
										...
										<tr>
											...
											<td>
											<a href="<?php echo BASE_URL.'model-edit/'.$obj->model_id?>">
													<button class="btn btn-sm btn-success" title="Edit">
														<i class="fa fa-edit"></i>
													</button> 
												</a>
												<?php echo get_delete_btn(BASE_URL.'delete-model/'.$obj->model_id); ?>
											</td>
										</tr>
									<?php endforeach;
...
<!-- End Main Content-->
<?php $this->load->view('Backend/Settings/add-model');?>
