...
<div class="modal" id="add-<?php echo $page_title?>">
	<div class="modal-dialog" role="document">
		<div class="modal-content modal-content-demo">
			<form action="<?php echo BASE_URL.'department-list'?>" method="POST" id="add-<?php echo $page_title?>" data-parsley-validate="">
				...
				<div class="modal-body">
					...
					<div class="row row-xs align-items-center mg-b-20">
						...
						<div class="col-md-8 mg-t-5 mg-md-t-0">	
							<input class="form-control" name="<?php echo $page_title?>_name" id="<?php echo $page_title?>_name" value="<?php echo $department_detail->name ?? NULL; ?>" placeholder="Enter <?php echo $page_title?> name" required="" type="text">
						</div>
					</div>
				</div>
