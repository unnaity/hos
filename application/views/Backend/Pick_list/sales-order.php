                            ...
                            <div class="table-responsive mg-t-40">
                                <table class="table table-invoice table-bordered">
                                    ...
                                    <tbody>
                                        ...
                                        ?>
                                        <tr>
                                            <td><?php echo $obj->product_alias ?></td>
                                            <td><?php echo $obj->hsn_code; ?></td>
                                            <td><?php echo $obj->quantity; ?></td>
                                            <td><?php echo $obj->price_per_unit ?></td>
                                            <td class="tx-end"><?php echo ($obj->quantity*$obj->price_per_unit); ?></td>
                                            <td class="tx-end"><?php echo $discount; ?></td>
                                            <td class="tx-end"><?php echo ($obj->quantity*$obj->price_per_unit)-$discount; ?></td>
                                        </tr>
                                        <?php } } ?>                                       
                                        <tr>
                                        ...
                                        <tr>
                                            ...
                                            <td class="tx-end" colspan="2">
                                                <h4 class="tx-bold"><?php echo $total;?></h4>
                                            </td>
                                        </tr>
                                    </tbody>
                                </table>
