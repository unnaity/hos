                                        ...
                                        <div class="row">
                                            <div class="col-md-12">
                                                <div class="form-group">
                                                    ...
                                                    <select class="form-control select2" name="sfg_grn_id" required id="sfg_grn_id">
                                                        <option value="">Select GRN No</option>
                                                        <?php if ($grn_list):
                                                            foreach ($grn_list as $obj): ?>
                                                                <option value="<?php echo $obj->sfg_grn_id; ?>"><?php echo $obj->sfg_grn_no; ?></option>
                                                        <?php endforeach;
                                                        endif;
                                                        ?>
                                                    </select>
