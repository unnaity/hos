		...
		<div class="main-container container-fluid">
			...
			<div class="page-header" style="min-height:unset;">
				...
				<div class="btn btn-list">
					...
					<a class="btn ripple btn-success" href="<?php echo BASE_URL.'add-oem'?>" title="Add OEM"><i class="fe fe-plus"></i></a>
				</div>
			</div>
			<!-- End Page Header -->
						...
						<div class="card-body">
							...
							<div class="table-responsive">
								<table id="example2" class="table table-striped table-bordered text-nowrap" style="border-left:1px solid #e1e6f1;">
									...
									<tbody>
									<?php if(isset($this->oem_list)):
										foreach($this->oem_list as $obj): ?>
										<tr>
